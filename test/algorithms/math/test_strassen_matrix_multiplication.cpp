...
// BOOST_AUTO_TEST_SUITE(TestStrassenMatrixMultiplication)

//BOOST_AUTO_TEST_CASE(empty_matrices)
//{
...
//BOOST_AUTO_TEST_CASE(matrices_with_wrong_dimensions)
//{
//    BOOST_CHECK(Matrix<int>() == StrassenMatrixMultiplication(
//            Matrix<int>(1, 1, 1), Matrix<int>(2, 3, 1)));
//}

//BOOST_AUTO_TEST_CASE(small_matrices)
//{
...
//BOOST_AUTO_TEST_CASE(big_matrices)
//{
