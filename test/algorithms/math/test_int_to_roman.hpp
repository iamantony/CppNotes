#ifndef TEST_INT_TO_ROMAN_HPP
#define TEST_INT_TO_ROMAN_HPP
...
BOOST_AUTO_TEST_CASE(test_int2rom_invalid_numbers)
{
...
BOOST_AUTO_TEST_CASE(test_int2rom_main_numbers)
{
...
BOOST_AUTO_TEST_CASE(test_int2rom_main_susbstract_numbers)
{
...
BOOST_AUTO_TEST_CASE(test_int2rom_main_valid_numbers)
{
