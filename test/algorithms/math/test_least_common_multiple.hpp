#ifndef TEST_LEAST_COMMON_MULTIPLE_HPP
#define TEST_LEAST_COMMON_MULTIPLE_HPP
...
BOOST_AUTO_TEST_CASE(test_lcm_numbers) {
...
BOOST_AUTO_TEST_CASE(test_lcm_random_numbers) {
...
#endif // TEST_LEAST_COMMON_MULTIPLE_HPP
