#ifndef TEST_ROMAN_TO_INT_HPP
#define TEST_ROMAN_TO_INT_HPP

#include <boost/test/unit_test.hpp>

#include "algorithms/math/roman_to_int.hpp"

BOOST_AUTO_TEST_CASE(test_rom2int_main_numbers)
{
...
BOOST_AUTO_TEST_CASE(test_rom2int_main_susbstract_numbers)
{
...
BOOST_AUTO_TEST_CASE(test_rom2int_main_valid_numbers)
{
