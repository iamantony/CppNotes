#ifndef TEST_FIND_THREE_SUM_CLOSEST_HPP
#define TEST_FIND_THREE_SUM_CLOSEST_HPP

#include <boost/test/unit_test.hpp>

#include "algorithms/search/find_three_sum_closest.hpp"

BOOST_AUTO_TEST_CASE(test_ftsc_vector_invalid_size)
{
    {
        std::vector<int> nums = {};
        int target = 0;
...
BOOST_AUTO_TEST_CASE(test_ftsc_valid_sum)
{
    {
...
#endif // TEST_FIND_THREE_SUM_CLOSEST_HPP
