#ifndef TEST_MERGE_SORTED_ARRAYS_HPP
#define TEST_MERGE_SORTED_ARRAYS_HPP

#include <boost/test/unit_test.hpp>

#include "algorithms/data_structures/array/merge_sorted_arrays.hpp"

BOOST_AUTO_TEST_CASE(test_msa_invalid_args)
{
    {
...
BOOST_AUTO_TEST_CASE(test_msa_one_empty_array)
{
    {
...
BOOST_AUTO_TEST_CASE(test_msa_valid_arrays)
{
    {
...
#endif // TEST_MERGE_SORTED_ARRAYS_HPP
