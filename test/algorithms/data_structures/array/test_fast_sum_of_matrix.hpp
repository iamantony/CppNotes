#ifndef TEST_FAST_SUM_OF_MATRIX_HPP
#define TEST_FAST_SUM_OF_MATRIX_HPP
...
BOOST_AUTO_TEST_CASE(test_fsom_small_matrix) {
...
BOOST_AUTO_TEST_CASE(test_fsom_rand_tests) {
...
#endif // TEST_FAST_SUM_OF_MATRIX_HPP
