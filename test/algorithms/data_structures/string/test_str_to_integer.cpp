...
#include "algorithms/data_structures/string/str_to_integer.hpp"

BOOST_AUTO_TEST_SUITE(StringToInteger)

BOOST_AUTO_TEST_CASE(empty_string)
{
    Algo::DS::String::StrToInt solution;
    BOOST_CHECK(0 == solution.myAtoi(""));
    BOOST_CHECK(0 == solution.myAtoi(" "));
    BOOST_CHECK(0 == solution.myAtoi("    "));
}

BOOST_AUTO_TEST_CASE(valid_number_in_string)
{
    Algo::DS::String::StrToInt solution;
...
BOOST_AUTO_TEST_CASE(string_with_non_digits)
{
    Algo::DS::String::StrToInt solution;
...
BOOST_AUTO_TEST_CASE(huge_number)
{
    Algo::DS::String::StrToInt solution;
