#ifndef TEST_INTERVAL_MAP_HPP
#define TEST_INTERVAL_MAP_HPP
...
BOOST_AUTO_TEST_CASE(test_im_special) {
...
BOOST_AUTO_TEST_CASE(test_im_random_with_check_vector)
{
...
BOOST_AUTO_TEST_CASE(test_im_random_values)
{
    std::random_device rd;
    std::mt19937 gen(rd());
