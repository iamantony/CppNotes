...
#include "types/ds/vector_ds.hpp"
...
BOOST_AUTO_TEST_CASE(create_vector)
{
...
BOOST_AUTO_TEST_CASE(create_with_size_and_default_value)
{
    Item item(42);
...
BOOST_AUTO_TEST_CASE(find_element)
{
