...
BOOST_AUTO_TEST_CASE(create_empty_linkedlist)
{
...
BOOST_AUTO_TEST_CASE(create_with_size)
{
...
BOOST_AUTO_TEST_CASE(create_from_vector)
{
...
BOOST_AUTO_TEST_CASE(access_elements)
{
    {
        DS::LinkedList<int> list;
...
BOOST_AUTO_TEST_CASE(access_n_from_end)
{
    std::vector<int> vector({1, 2, 3, 4, 5});
    DS::LinkedList<int> list(vector);
...
BOOST_AUTO_TEST_CASE(remove_values)
{
